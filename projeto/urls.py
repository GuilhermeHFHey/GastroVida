...
from app.views import editCir, updateCir, cirurgiaForm, createCirurgia, home, form, create, view, edit, update, delete, uploadExel, loginPage, registerPage, initial, editPac, updatePac, editCon, updateCon
